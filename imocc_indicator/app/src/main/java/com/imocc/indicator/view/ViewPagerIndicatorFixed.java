 ...
 */
public class ViewPagerIndicatorFixed extends LinearLayout {
    ...
    private static final String TAG = ViewPagerIndicatorFixed.class.getSimpleName();

    public ViewPagerIndicatorFixed(Context context) {
        this(context, null);
    }

    public ViewPagerIndicatorFixed(Context context, AttributeSet attrs) {
        super(context, attrs);
